...
class MeowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meow" do
    assert_difference('Meow.count') do
      post meows_url, params: { meow: { description: @meow.description, user_id: @meow.user_id } }
    end
  ...
  test "should update meow" do
    patch meow_url(@meow), params: { meow: { description: @meow.description, user_id: @meow.user_id } }
